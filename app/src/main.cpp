                ...
                Pattern{"Data",false,
                    {
                        Pattern{"Title",true},
                        Pattern{"PAN",true},
                        Pattern{"TerminalID",true},
                        Pattern{"MerchantID",true},
                        Pattern{"MerchantName",true},
                        Pattern{"Description",true},
                        Pattern{"TitleEN",true},
                        Pattern{"IsTwoReceipts",true},
                        Pattern{"IsStraightToVAsMenu",true},
                        Pattern{"RegionID",true},
                        Pattern{"ServiceType",true,
                            {
                                Pattern{"Id"},
                                Pattern{"Title"},
                                Pattern{"Description"}
                        ...
                        Pattern{"Details",true,
                            {
                            Pattern{"TerminalCardDetail",true,
                                {
                                    Pattern{"Name"},
                                    Pattern{"Price"},
                                    Pattern{"Description"},
...
//    VasMenuInfo vasInfo{"./Parent/Data/Details/TerminalCardDetail"};
    ...
    const std::unordered_map<VasMenuAttribute, std::string> attributeNames = {
        ...
        {VasMenuAttribute::ID, "ID"},
        {VasMenuAttribute::Counter, "Counter"}
    };

    StructInfo<VasMenuAttribute> structInfo{"./Parent/Data/Details/TerminalCardDetail",attributeNames};
